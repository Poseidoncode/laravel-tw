...
const sidebarItems = [
    ...
    },
    {
        title: '深入探討',
            items: [
                { title: 'Artisan 命令列 (Artisan Console)', href: '/docs/artisan' },
                { title: '廣播 (Broadcasting)', href: '/docs/broadcasting' },
                { title: '快取 (Cache)', href: '/docs/cache' },
                { title: '集合 (Collections)', href: '/docs/collections' },
                { title: '並行 (Concurrency)', href: '/docs/concurrency' },
                { title: 'Context', href: '/docs/context' },
                { title: '契約 (Contracts)', href: '/docs/contracts' },
                { title: '事件 (Events)', href: '/docs/events' },
                { title: '檔案儲存 (File Storage)', href: '/docs/filesystem' },
                { title: '輔助函式 (Helpers)', href: '/docs/helpers' },
                { title: 'HTTP 客戶端 (HTTP Client)', href: '/docs/http-client' },
                { title: '本地化(Localization)', href: '/docs/localization' },
                { title: '郵件 (Mail)', href: '/docs/mail' },
                { title: '通知 (Notifications)', href: '/docs/notifications' },
                { title: '套件 (Packages)', href: '/docs/packages' },
                { title: '程序 (Processes)', href: '/docs/processes' },
                { title: '佇列 (Queues)', href: '/docs/queues' },
                { title: '速率限制 (Rate Limiting)', href: '/docs/rate-limiting' },
                { title: '字串 (Strings)', href: '/docs/strings' },
                { title: '任務排程 (Scheduling)', href: '/docs/scheduling' },
            ]
    },
    {
        title: '安全性',
