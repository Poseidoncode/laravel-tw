...
- [設定 (Configuration)](#configuration)
  - [應用程式憑證 (Application Credentials)](#application-credentials)
  - [允許的來源 (Allowed Origins)](#allowed-origins)
  - [額外的應用程式 (Additional Applications)](#additional-applications)
  - [SSL](#ssl)
- [執行伺服器 (Running the Server)](#running-server)
  - [除錯 (Debugging)](#debugging)
  - [重新啟動 (Restarting)](#restarting)
- [監控 (Monitoring)](#monitoring)
- [在正式環境執行 Reverb (Running Reverb in Production)](#production)
  - [開啟的檔案 (Open Files)](#open-files)
  - [事件迴圈 (Event Loop)](#event-loop)
  - [網頁伺服器 (Web Server)](#web-server)
  - [連接埠 (Ports)](#ports)
  - [程序管理 (Process Management)](#process-management)
  - [擴展 (Scaling)](#scaling)
