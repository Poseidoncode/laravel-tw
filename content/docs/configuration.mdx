...
description: Laravel 的設定主要目的在提供一個強大、集中的地方來管理應用程式的設定、環境和服務。
---
...
<div className="overflow-auto">
  <table className="min-w-full text-left border-collapse">
    <thead>
      <tr>
        <th className="px-3 py-2">`.env` 值</th>
        <th className="px-3 py-2">`env()` 值</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        ...
        <td className="px-3 py-2">`(bool) true`</td>
      </tr>
      <tr>
        <td className="px-3 py-2">`(true)`</td>
        <td className="px-3 py-2">`(bool) true`</td>
      ...
      <tr>
        ...
        <td className="px-3 py-2">`(bool) false`</td>
      </tr>
      <tr>
        <td className="px-3 py-2">`(false)`</td>
        <td className="px-3 py-2">`(bool) false`</td>
      ...
      <tr>
        ...
        <td className="px-3 py-2">`(null) null`</td>
      </tr>
      <tr>
        <td className="px-3 py-2">`(null)`</td>
        <td className="px-3 py-2">`(null) null`</td>
