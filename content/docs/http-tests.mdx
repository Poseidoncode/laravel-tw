...
- [發送請求 (Making Requests)](#making-requests)
  - [自訂請求標頭 (Customizing Request Headers)](#customizing-request-headers)
  - [Cookies](#cookies)
  - [Session / 認證 (Session / Authentication)](#session-and-authentication)
  - [除錯回應 (Debugging Responses)](#debugging-responses)
  - [例外處理 (Exception Handling)](#exception-handling)
- [測試 JSON API (Testing JSON APIs)](#testing-json-apis)
  - [流暢 JSON 測試 (Fluent JSON Testing)](#fluent-json-testing)
- [測試檔案上傳 (Testing File Uploads)](#testing-file-uploads)
- [測試視圖 (Testing Views)](#testing-views)
  - [渲染 Blade 和組件 (Rendering Blade and Components)](#rendering-blade-and-components)
- [快取路由 (Caching Routes)](#caching-routes)
- [可用斷言 (Available Assertions)](#available-assertions)
  - [回應斷言 (Response Assertions)](#response-assertions)
  - [認證斷言 (Authentication Assertions)](#authentication-assertions)
  - [驗證斷言 (Validation Assertions)](#validation-assertions)
