...
#### 不應被別名的類別 (Classes That Should Not Be Aliased)
...
#### 型別提示依賴 (Type Hinting Dependencies)
...
#### Closure 指令描述 (Closure Command Descriptions)
...
#### 佇列 Artisan 指令 (Queueing Artisan Commands)
