...
- [簡介 (Introduction)](#introduction)
  - [快取設定 (Cache Configuration)](#cache-configuration)
- [基本用法 (Basic Usage)](#basic-usage)
  - [手動遞增嘗試次數 (Manually Incrementing Attempts)](#manually-incrementing-attempts)
  - [清除嘗試次數 (Clearing Attempts)](#clearing-attempts)
...
> [!NOTE]
> 如果你對限制傳入 HTTP 請求的速率感興趣，請參閱 [速率限制器 middleware 文件](/docs/12.x/routing#rate-limiting)。
