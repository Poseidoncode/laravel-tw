...
> [!NOTE]
> Before refining these options, make sure you are familiar with Laravel's default [queue services](/docs/12.x/queues#max-job-attempts-and-timeout) and the concept of 'attempts'.
