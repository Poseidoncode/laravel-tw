...
- [安裝與設定 (Installation and Setup)](#installation-and-setup)
  - [第一步 (First Steps)](#first-steps)
  - [設定 Homestead (Configuring Homestead)](#configuring-homestead)
  - [設定 Nginx 網站 (Configuring Nginx Sites)](#configuring-nginx-sites)
  - [設定服務 (Configuring Services)](#configuring-services)
  - [啟動 Vagrant Box (Launching the Vagrant Box)](#launching-the-vagrant-box)
  - [各專案獨立安裝 (Per Project Installation)](#per-project-installation)
  - [安裝可選功能 (Installing Optional Features)](#installing-optional-features)
  - [Aliases](#aliases)
- [更新 Homestead (Updating Homestead)](#updating-homestead)
- [日常使用 (Daily Usage)](#daily-usage)
  - [透過 SSH 連線 (Connecting via SSH)](#connecting-via-ssh)
  - [新增額外網站 (Adding Additional Sites)](#adding-additional-sites)
  - [環境變數 (Environment Variables)](#environment-variables)
  - [連接埠 (Ports)](#ports)
  - [PHP 版本 (PHP Versions)](#php-versions)
  - [連線至資料庫 (Connecting to Databases)](#connecting-to-databases)
  - [資料庫備份 (Database Backups)](#database-backups)
  - [設定 Cron 排程 (Configuring Cron Schedules)](#configuring-cron-schedules)
  - [設定 Mailpit (Configuring Mailpit)](#configuring-mailpit)
  - [設定 Minio (Configuring Minio)](#configuring-minio)
  - [Laravel Dusk](#laravel-dusk)
  - [分享你的環境 (Sharing Your Environment)](#sharing-your-environment)
- [除錯與分析 (Debugging and Profiling)](#debugging-and-profiling)
  - [使用 Xdebug 對 Web 請求進行除錯 (Debugging Web Requests With Xdebug)](#debugging-web-requests)
  - [除錯 CLI 應用程式 (Debugging CLI Applications)](#debugging-cli-applications)
  - [使用 Blackfire 分析應用程式 (Profiling Applications With Blackfire)](#profiling-applications-with-blackfire)
- [網路介面 (Network Interfaces)](#network-interfaces)
- [擴充 Homestead (Extending Homestead)](#extending-homestead)
- [供應商特定設定 (Provider Specific Settings)](#provider-specific-settings)
