---
title: "Sail (Laravel Sail)"
description: Sail 是 Laravel 的輕量命令列介面
---

- [簡介](#introduction)
- [安裝與設定](#installation) - [在既有專案中安裝 Sail](#installing-sail-into-existing-applications) - [重新建立 Sail 映像檔](#rebuilding-sail-images) - [設定 Shell Alias（別名）](#configuring-a-shell-alias)
...
> [!WARNING]
> 使用 MinIO 時不支援透過 `temporaryUrl` 方法產生暫時性儲存 URL。
...
> [!NOTE] > `share` 指令是由 [Expose](https://github.com/beyondcode/expose) 支援，該服務由 BeyondCode 提供，是一套開放原始碼的穿透（tunneling）工具。
