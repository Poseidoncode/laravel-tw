...
77:["$","p",null,{"children":["If you have stored a file on one of your ",["$","a",null,{"href":"/docs/filesystem","children":"filesystem disks"}],", you may attach it to the email using the ",["$","code",null,{"children":"fromStorage"}]," attachment method:"]}]
...
91:["$","p",null,{"children":["Of course, attachment data may be stored on a remote file storage service such as Amazon S3. So, Laravel also allows you to generate attachment instances from data that is stored on one of your application's ",["$","a",null,{"href":"/docs/filesystem","children":"filesystem disks"}],":"]}]
...
de:["$","p",null,{"children":["This method will automatically take care of pushing a job onto the queue so the message is sent in the background. You will need to ",["$","a",null,{"href":"/docs/queues","children":"configure your queues"}]," before using this feature."]}]
...
12b:["$","p",null,{"children":["If you are using ",["$","a",null,{"href":"/docs/sail","children":"Laravel Sail"}],", you may preview your messages using ",["$","a",null,{"href":"https://github.com/axllent/mailpit","children":"Mailpit"}],". When Sail is running, you may access the Mailpit interface at: ",["$","code",null,{"children":"http://localhost:8025"}],"."]}]
