...
24:["$","p",null,{"children":["S3 磁碟設定陣列位於你的 ",["$","code",null,{"children":"config/filesystems.php"}]," 設定檔中。通常,你應該使用以下環境變數來設定你的 S3 資訊和憑證,這些環境變數由 ",["$","code",null,{"children":"config/filesystems.php"}]," 設定檔引用:"]}]
...
37:["$","p",null,{"children":["你可以透過定義使用 ",["$","code",null,{"children":"scoped"}]," 驅動程式的磁碟來建立任何現有檔案系統磁碟的路徑作用域實例。例如,你可以建立一個磁碟,將你現有的 ",["$","code",null,{"children":"s3"}]," 磁碟的作用域限定到特定的路徑前綴,然後使用作用域磁碟的每個檔案操作都將使用指定的前綴:"]}]
...
49:["$","p",null,{"children":[["$","code",null,{"children":"Storage"}]," facade 可用於與你的任何設定磁碟互動。例如,你可以在 facade 上使用 ",["$","code",null,{"children":"put"}]," 方法將頭像儲存到預設磁碟。如果你在 ",["$","code",null,{"children":"Storage"}]," facade 上呼叫方法而不先呼叫 ",["$","code",null,{"children":"disk"}]," 方法,該方法將自動傳遞給預設磁碟:"]}]
...
61:["$","p",null,{"children":["你可以使用 ",["$","code",null,{"children":"url"}]," 方法來取得給定檔案的 URL。如果你使用 ",["$","code",null,{"children":"local"}]," 驅動程式,這通常只會在給定路徑前面加上 ",["$","code",null,{"children":"/storage"}]," 並返回檔案的相對 URL。如果你使用 ",["$","code",null,{"children":"s3"}]," 驅動程式,將返回完全限定的遠端 URL:"]}]
...
74:["$","pre",null,{"children":["$","code",null,{"className":"language-php","children":"$$url = Storage::temporaryUrl(\n    'file.jpg',\n    now()->addMinutes(5),\n    [\n        'ResponseContentType' => 'application/octet-stream',\n        'ResponseContentDisposition' => 'attachment; filename=file2.jpg',\n    ]\n);\n"}]}]
...
88:["$","h4",null,{"id":"檔案路徑","children":["$","a",null,{"href":"#檔案路徑","children":"檔案路徑"}]}]
...
9f:["$","p",null,{"children":["將檔案串流到儲存可顯著減少記憶體使用。如果你希望 Laravel 自動管理將給定檔案串流到你的儲存位置,你可以使用 ",["$","code",null,{"children":"putFile"}]," 或 ",["$","code",null,{"children":"putFileAs"}]," 方法。此方法接受 ",["$","code",null,{"children":"Illuminate\\Http\\File"}]," 或 ",["$","code",null,{"children":"Illuminate\\Http\\UploadedFile"}]," 實例,並將自動將檔案串流到你所需的位置:"]}]
...
ad:["$","p",null,{"children":["If you do not want a filename to be automatically assigned to your stored file, you may use the ",["$","code",null,{"children":"storeAs"}]," method, which receives the path, the filename, and the (optional) disk as its arguments:"]}]
...
c0:["$","p",null,{"children":["在 Laravel 的 Flysystem 整合中,「可見性」是跨多個平台的檔案權限的抽象。檔案可以被宣告為 ",["$","code",null,{"children":"public"}]," 或 ",["$","code",null,{"children":"private"}],"。當檔案被宣告為 ",["$","code",null,{"children":"public"}]," 時,你表示該檔案通常應該對其他人可存取。例如,當使用 S3 驅動程式時,你可以檢索 ",["$","code",null,{"children":"public"}]," 檔案的 URL。"]}]
...
d6:["$","pre",null,{"children":["$","code",null,{"className":"language-php","children":"use Illuminate\\Support\\Facades\\Storage;\n\n$files = Storage::files($directory);\n\n$files = Storage::allFiles($directory);\n"}]}]
...
f2:["$","p",null,{"children":["一旦你建立並註冊了擴展的服務提供者,你就可以在 ",["$","code",null,{"children":"config/filesystems.php"}]," 設定檔中使用 ",["$","code",null,{"children":"dropbox"}]," 驅動程式。"]}]
a:[["$","meta","0",{"charSet":"utf-8"}],["$","meta","1",{"name":"viewport","content":"width=device-width, initial-scale=1"}]]
f4:I[27201,["/_next/static/chunks/ff1a16fafef87110.js","/_next/static/chunks/247eb132b7f7b574.js"],"IconMark"]
