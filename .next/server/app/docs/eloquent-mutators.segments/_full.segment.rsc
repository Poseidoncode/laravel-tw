...
1d:["$","pre",null,{"children":["$","code",null,{"className":"language-php","children":"protected function hash(): Attribute\n{\n    return Attribute::make(\n        get: fn (string $value) => bcrypt(gzuncompress($value)),\n    )->shouldCache();\n}\n"}]}]
...
39:["$","p",null,{"children":["You may use the ",["$","code",null,{"children":"Illuminate\\Database\\Eloquent\\Casts\\AsStringable"}]," cast class to cast a model attribute to a ",["$","a",null,{"href":"/docs/strings#fluent-strings-method-list","children":"fluent Illuminate\\Support\\Stringable object"}],":"]}]
...
41:["$","p",null,{"children":["To update a single field of a JSON attribute with a more terse syntax, you may ",["$","a",null,{"href":"/docs/eloquent#mass-assignment-json-columns","children":"make the attribute mass assignable"}]," and use the ",["$","code",null,{"children":"->"}]," operator when calling the ",["$","code",null,{"children":"update"}]," method:"]}]
...
4d:["$","p",null,{"children":["Similarly, Laravel offers an ",["$","code",null,{"children":"AsCollection"}]," cast that casts your JSON attribute to a Laravel ",["$","a",null,{"href":"/docs/collections","children":"Collection"}]," instance:"]}]
...
51:["$","p",null,{"children":["The ",["$","code",null,{"children":"of"}]," method may be used to indicate collection items should be mapped into a given class via the collection's ",["$","a",null,{"href":"/docs/collections#method-mapinto","children":"mapInto method"}],":"]}]
...
58:["$","p",null,{"children":["When defining a ",["$","code",null,{"children":"date"}]," or ",["$","code",null,{"children":"datetime"}]," cast, you may also specify the date's format. This format will be used when the ",["$","a",null,{"href":"/docs/eloquent-serialization","children":"model is serialized to an array or JSON"}],":"]}]
...
65:["$","p",null,{"children":["Eloquent also allows you to cast your attribute values to PHP ",["$","a",null,{"href":"https://www.php.net/manual/en/language.enumerations.backed.php","children":"Enums"}],". To accomplish this, you may specify the attribute and enum you wish to cast in your model's ",["$","code",null,{"children":"casts"}]," method:"]}]
...
77:["$","pre",null,{"children":["$","code",null,{"className":"language-php","children":"use App\\Models\\Post;\nuse App\\Models\\User;\n\n$users = User::select([\n    'users.*',\n    'last_posted_at' => Post::selectRaw('MAX(created_at)')\n        ->whereColumn('user_id', 'users.id')\n])->get();\n"}]}]
...
a0:["$","h3",null,{"id":"comparing-cast-values","children":["$","a",null,{"href":"#comparing-cast-values","children":"Comparing Cast Values"}]}]
...
b3:I[27201,["/_next/static/chunks/ff1a16fafef87110.js","/_next/static/chunks/247eb132b7f7b574.js"],"IconMark"]
