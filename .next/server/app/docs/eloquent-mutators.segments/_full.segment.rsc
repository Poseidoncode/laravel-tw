...
58:["$","p",null,{"children":["When defining a ",["$","code",null,{"children":"date"}]," or ",["$","code",null,{"children":"datetime"}]," cast, you may also specify the date's format. This format will be used when the ",["$","a",null,{"href":"/docs/%7B'12.x'%7D/eloquent-serialization","children":"model is serialized to an array or JSON"}],":"]}]
